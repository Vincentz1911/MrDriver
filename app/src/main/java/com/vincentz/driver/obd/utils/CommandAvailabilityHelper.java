 ...
 * the License.
 */
package com.vincentz.driver.obd.utils;
...
public abstract class CommandAvailabilityHelper {
     ...
     *
     * This is a direct call to {@link com.vincentz.driver.obd.utils.CommandAvailabilityHelper#isAvailable(String, int[])} with built-in String digestion
     *
     * @param commandPid a {@link String} object.
     * @param availabilityString a {@link String} object.
     * @return a boolean.
